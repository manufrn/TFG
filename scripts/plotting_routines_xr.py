...
def plot_fit_variable(df, variable, period=None, plot=True, wide=True):
...
def plot_profile_fit(df, data, date_i, save=False):
...
def plot_multiple_profiles(df, data, dates_i):
